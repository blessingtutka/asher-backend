...
import { getWorkerProfile, setWorkerProfile, getYourWorkerProfile, getAllWorkers, searchWorkerProfiles } from '../controllers/worker.controller';
...
workerRoutes.get('/search', searchWorkerProfiles);
